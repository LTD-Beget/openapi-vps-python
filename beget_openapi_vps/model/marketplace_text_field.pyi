...
class MarketplaceTextField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["common", "is_editable", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["common", "is_editable", ], str]):
