...
class ManageDetachFromPrivateNetworkResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ManageDetachFromPrivateNetworkResponseError']:
                return ManageDetachFromPrivateNetworkResponseError
            __annotations__ = {
                "vps": vps,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ManageDetachFromPrivateNetworkResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ManageDetachFromPrivateNetworkResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ManageDetachFromPrivateNetworkResponseError', schemas.Unset] = schemas.unset,
