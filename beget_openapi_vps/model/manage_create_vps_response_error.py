            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "INVALID_LINK_SLUG": "INVALID_LINK_SLUG",
                        "NOT_ENOUGH_SPACE": "NOT_ENOUGH_SPACE",
                        "SOFTWARE_TEMPORARY_UNAVAILABLE": "SOFTWARE_TEMPORARY_UNAVAILABLE",
                        "IMAGE_REGION_MISMATCH": "IMAGE_REGION_MISMATCH",
                        "ADDRESS_NOT_OWNED": "ADDRESS_NOT_OWNED",
                        "MULTIPLE_IPS_NOT_SUPPORTED_YET": "MULTIPLE_IPS_NOT_SUPPORTED_YET",
                        "CONFLICTING_NETWORK_FIELDS": "CONFLICTING_NETWORK_FIELDS",
                ...
                @schemas.classproperty
                def INVALID_LINK_SLUG(cls):
                    return cls("INVALID_LINK_SLUG")
                
                @schemas.classproperty
                def NOT_ENOUGH_SPACE(cls):
                    return cls("NOT_ENOUGH_SPACE")
                
                @schemas.classproperty
                def SOFTWARE_TEMPORARY_UNAVAILABLE(cls):
                    return cls("SOFTWARE_TEMPORARY_UNAVAILABLE")
                
                @schemas.classproperty
                def IMAGE_REGION_MISMATCH(cls):
                    return cls("IMAGE_REGION_MISMATCH")
                
                @schemas.classproperty
                def ADDRESS_NOT_OWNED(cls):
                    return cls("ADDRESS_NOT_OWNED")
                
                @schemas.classproperty
                def MULTIPLE_IPS_NOT_SUPPORTED_YET(cls):
                    return cls("MULTIPLE_IPS_NOT_SUPPORTED_YET")
                
                @schemas.classproperty
                def CONFLICTING_NETWORK_FIELDS(cls):
                    return cls("CONFLICTING_NETWORK_FIELDS")
                
                @schemas.classproperty
                def UNSUPPORTED_IP_VERSION(cls):
                    return cls("UNSUPPORTED_IP_VERSION")
