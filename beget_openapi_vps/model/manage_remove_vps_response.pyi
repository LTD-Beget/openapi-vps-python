...
class ManageRemoveVpsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ManageRemoveVpsResponseError']:
                return ManageRemoveVpsResponseError
            __annotations__ = {
                "vps": vps,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ManageRemoveVpsResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ManageRemoveVpsResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ManageRemoveVpsResponseError', schemas.Unset] = schemas.unset,
