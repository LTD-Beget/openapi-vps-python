...
class NetworkRemovePrivateNetworkResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['NetworkRemovePrivateNetworkResponseError']:
                return NetworkRemovePrivateNetworkResponseError
            __annotations__ = {
                "network": network,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'NetworkRemovePrivateNetworkResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['NetworkRemovePrivateNetworkResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['NetworkRemovePrivateNetworkResponseError', schemas.Unset] = schemas.unset,
