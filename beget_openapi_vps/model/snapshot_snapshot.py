...
class SnapshotSnapshot(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "vps_id", "vps_name", "vps_exists", "date_create", "size", "status", "description", "configuration", "price_day", "price_hour", "region", "installed_software", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "vps_id", "vps_name", "vps_exists", "date_create", "size", "status", "description", "configuration", "price_day", "price_hour", "region", "installed_software", ], str]):
