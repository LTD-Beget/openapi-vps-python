...
class SnapshotRestore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "snapshot", "vps_id", "vps_name", "target_type", "date_create", "date_complete", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "snapshot", "vps_id", "vps_name", "target_type", "date_create", "date_complete", "status", ], str]):
