...
class ManageDetachSshKeyResponseError(
    schemas.DictSchema
):
            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "GUEST_OS_KEY_MANAGE_FAILED": "GUEST_OS_KEY_MANAGE_FAILED",
                    }
                ...
                @schemas.classproperty
                def GUEST_OS_KEY_MANAGE_FAILED(cls):
                    return cls("GUEST_OS_KEY_MANAGE_FAILED")
