    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class field_value(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresInstalledSoftwareInfoFieldValue'], typing.List['StructuresInstalledSoftwareInfoFieldValue']],
            ...
            class license(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresIssuedSoftwareLicense'], typing.List['StructuresIssuedSoftwareLicense']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'license':
                    return super().__new__(
                        cls,
