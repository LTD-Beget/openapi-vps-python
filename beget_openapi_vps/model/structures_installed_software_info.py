...
class StructuresInstalledSoftwareInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "display_name", "version", "address", "status", "field_value", "metadata", "description", "description_en", "category", "slug", "post_install_alert", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "display_name", "version", "address", "status", "field_value", "metadata", "description", "description_en", "category", "slug", "post_install_alert", ], str]):
