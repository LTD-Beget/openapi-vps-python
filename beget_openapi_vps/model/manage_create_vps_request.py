...
class ManageCreateVpsRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["display_name", "hostname", "description", "configuration_id", "configuration_params", "software", "snapshot_id", "image_id", "ssh_keys", "password", "beget_ssh_access_allowed", "private_networks", "link_slug", "license_id", "region", "configuration_group", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["display_name", "hostname", "description", "configuration_id", "configuration_params", "software", "snapshot_id", "image_id", "ssh_keys", "password", "beget_ssh_access_allowed", "private_networks", "link_slug", "license_id", "region", "configuration_group", ], str]):
