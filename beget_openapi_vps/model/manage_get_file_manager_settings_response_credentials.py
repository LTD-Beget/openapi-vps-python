...
class ManageGetFileManagerSettingsResponseCredentials(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "user", "host", "connection_id", "path", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "user", "host", "connection_id", "path", ], str]):
