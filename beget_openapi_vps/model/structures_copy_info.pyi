...
class StructuresCopyInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "items", "vps_name", "size", "region", "configuration", "installed_software", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "items", "vps_name", "size", "region", "configuration", "installed_software", ], str]):
