...
class ManageChangeSshAccessResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ManageChangeSshAccessResponseError']:
                return ManageChangeSshAccessResponseError
            __annotations__ = {
                "vps": vps,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ManageChangeSshAccessResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ManageChangeSshAccessResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ManageChangeSshAccessResponseError', schemas.Unset] = schemas.unset,
