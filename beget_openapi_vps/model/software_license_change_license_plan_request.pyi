...
class SoftwareLicenseChangeLicensePlanRequest(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            new_license_id = schemas.IntSchema
            __annotations__ = {
                "vps_id": vps_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["new_license_id"]) -> MetaOapg.properties.new_license_id: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["vps_id", "license_id", "new_license_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["new_license_id"]) -> typing.Union[MetaOapg.properties.new_license_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["vps_id", "license_id", "new_license_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        new_license_id: typing.Union[MetaOapg.properties.new_license_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
