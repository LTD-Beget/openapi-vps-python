...
class StructuresPrivateNetwork(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "subnet", "mask", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "subnet", "mask", ], str]):
