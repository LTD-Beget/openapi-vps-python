...
class ManageAttachIpAddressResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ManageAttachIpAddressResponseError']:
                return ManageAttachIpAddressResponseError
            __annotations__ = {
                "vps": vps,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ManageAttachIpAddressResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ManageAttachIpAddressResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ManageAttachIpAddressResponseError', schemas.Unset] = schemas.unset,
