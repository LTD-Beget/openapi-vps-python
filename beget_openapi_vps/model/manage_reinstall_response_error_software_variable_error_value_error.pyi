...
class ManageReinstallResponseErrorSoftwareVariableErrorValueError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "error_text_ru", "error_text_en", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "error_text_ru", "error_text_en", ], str]):
