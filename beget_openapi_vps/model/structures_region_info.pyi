...
class StructuresRegionInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "name_en", "country", "available", "priority", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "name_en", "country", "available", "priority", ], str]):
