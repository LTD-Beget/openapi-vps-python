...
class SnapshotSnapshot(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "vps_id", "vps_name", "date_create", "size", "status", "description", "configuration", "price_day", "region", "installed_software", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "vps_id", "vps_name", "date_create", "size", "status", "description", "configuration", "price_day", "region", "installed_software", ], str]):
