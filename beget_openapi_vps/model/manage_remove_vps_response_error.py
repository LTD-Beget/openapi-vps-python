...
class ManageRemoveVpsResponseError(
    schemas.DictSchema
):
            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "ALREADY_REMOVING": "ALREADY_REMOVING",
                        "IMAGE_EXPORT_IN_PROGRESS": "IMAGE_EXPORT_IN_PROGRESS",
                ...
                @schemas.classproperty
                def ALREADY_REMOVING(cls):
                    return cls("ALREADY_REMOVING")
                
                @schemas.classproperty
                def IMAGE_EXPORT_IN_PROGRESS(cls):
                    return cls("IMAGE_EXPORT_IN_PROGRESS")
                
                @schemas.classproperty
                def IP_LIMIT_EXCEEDED(cls):
                    return cls("IP_LIMIT_EXCEEDED")
