...
class NetworkOrderIpAddressResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'StructuresAdditionalIpInfo': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip_address", "error", "items", "error_v2", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> typing.Union['StructuresAdditionalIpInfo', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip_address", "error", "items", "error_v2", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        items: typing.Union['StructuresAdditionalIpInfo', schemas.Unset] = schemas.unset,
