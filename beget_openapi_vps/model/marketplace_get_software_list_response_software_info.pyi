...
class MarketplaceGetSoftwareListResponseSoftwareInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            description_version_en = schemas.StrSchema
            ...
            __annotations__ = {
                ...
                "description_version_en": description_version_en,
                "metadata": metadata,
                "variable": variable,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["description_version_en"]) -> MetaOapg.properties.description_version_en: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "display_name", "version", "description", "description_en", "description_version", "description_version_en", "metadata", "variable", "field_data", "requirements", "category", "slug", "documentation_slug", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["description_version_en"]) -> typing.Union[MetaOapg.properties.description_version_en, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "display_name", "version", "description", "description_en", "description_version", "description_version_en", "metadata", "variable", "field_data", "requirements", "category", "slug", "documentation_slug", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        description_version_en: typing.Union[MetaOapg.properties.description_version_en, str, schemas.Unset] = schemas.unset,
