...
class StructuresIpInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "mac", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "mac", ], str]):
