...
class ManageVpsConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "cpu_count", "disk_size", "memory", "bandwidth_public", "price_day", "price_month", "price_hour", "available", "custom", "configurable", "region", "group", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "cpu_count", "disk_size", "memory", "bandwidth_public", "price_day", "price_month", "price_hour", "available", "custom", "configurable", "region", "group", ], str]):
