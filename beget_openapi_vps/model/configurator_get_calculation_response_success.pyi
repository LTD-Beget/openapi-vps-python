...
class ConfiguratorGetCalculationResponseSuccess(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["settings", "params", "price_day", "price_month", "price_hour", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["settings", "params", "price_day", "price_month", "price_hour", ], str]):
