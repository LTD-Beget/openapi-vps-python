    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class ip(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresIpInfo'], typing.List['StructuresIpInfo']],
            ...
            class additional_ip(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresAdditionalIpInfo'], typing.List['StructuresAdditionalIpInfo']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'additional_ip':
                    return super().__new__(
                        cls,
            ...
            class private_network(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['StructuresPrivateNetwork'], typing.List['StructuresPrivateNetwork']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'private_network':
                    return super().__new__(
                        cls,
