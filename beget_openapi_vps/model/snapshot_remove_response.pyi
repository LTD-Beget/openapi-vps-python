...
class SnapshotRemoveResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['SnapshotRemoveResponseError']:
                return SnapshotRemoveResponseError
            __annotations__ = {
                "items": items,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'SnapshotRemoveResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['SnapshotRemoveResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['SnapshotRemoveResponseError', schemas.Unset] = schemas.unset,
