...
class ManageAttachToPrivateNetworkResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ManageAttachToPrivateNetworkResponseError']:
                return ManageAttachToPrivateNetworkResponseError
            __annotations__ = {
                "vps": vps,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ManageAttachToPrivateNetworkResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ManageAttachToPrivateNetworkResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ManageAttachToPrivateNetworkResponseError', schemas.Unset] = schemas.unset,
