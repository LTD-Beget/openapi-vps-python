...
class MarketplaceFieldCommon(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "label", "label_en", "description", "description_en", "default_value", "is_additional", "is_required", "is_custom", "validation_regex", "validation_error_text", "validation_error_text_en", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "label", "label_en", "description", "description_en", "default_value", "is_additional", "is_required", "is_custom", "validation_regex", "validation_error_text", "validation_error_text_en", ], str]):
