...
class MarketplaceGetSoftwareListResponseSoftwareInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "display_name", "version", "description", "description_en", "metadata", "field_data", "requirements", "category", "slug", "documentation_slug", "unattended_install_available", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "display_name", "version", "description", "description_en", "metadata", "field_data", "requirements", "category", "slug", "documentation_slug", "unattended_install_available", ], str]):
