...
class StructuresInstalledSoftwareInfoFieldValue(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label_ru", "label_en", "value", "type", "items", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label_ru", "label_en", "value", "type", "items", ], str]):
