...
class StructuresOrderInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "items", "vps_name", "type", "date_create", "date_complete", "path", "status", "copy_info", "affect_live", "target", "error_details", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "items", "vps_name", "type", "date_create", "date_complete", "path", "status", "copy_info", "affect_live", "target", "error_details", ], str]):
