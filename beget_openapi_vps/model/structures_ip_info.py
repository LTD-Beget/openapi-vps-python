...
class StructuresIpInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "mac", "vps_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "mac", "vps_id", ], str]):
