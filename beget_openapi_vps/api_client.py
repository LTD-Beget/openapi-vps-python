...
from beget_openapi_vps import rest
from beget_openapi_vps.configuration import Configuration
from beget_openapi_vps.exceptions import ApiTypeError, ApiValueError
from beget_openapi_vps.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/v1.7.9/python'
