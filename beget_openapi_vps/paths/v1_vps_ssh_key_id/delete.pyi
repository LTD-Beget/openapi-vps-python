...
SchemaFor200ResponseBodyApplicationJson = SshKeyRemoveResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _ssh_key_service_remove_oapg(
        self,
...
class SshKeyServiceRemove(BaseApi):
    ...
    def ssh_key_service_remove(
        ...
        return self._ssh_key_service_remove_oapg(
