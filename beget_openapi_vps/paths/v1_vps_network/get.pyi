...
SchemaFor200ResponseBodyApplicationJson = NetworkGetNetworkInfoResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _network_service_get_network_info_oapg(
        self,
...
class NetworkServiceGetNetworkInfo(BaseApi):
    ...
    def network_service_get_network_info(
        ...
        return self._network_service_get_network_info_oapg(
