...
SchemaFor200ResponseBodyApplicationJson = ManageGetListResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _manage_service_get_list_oapg(
        self,
...
class ManageServiceGetList(BaseApi):
    ...
    def manage_service_get_list(
        ...
        return self._manage_service_get_list_oapg(
